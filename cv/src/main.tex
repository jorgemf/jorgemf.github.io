...
\begin{document}
	...
	\vspace{0.10 cm}
	\begin{onecolentry}
		Bachelor's Thesis: \textbf{Geometric Deep Learning}, a mathematical perspective.
	\end{onecolentry}
	...
	\begin{twocolentry}{
		...
		\textit{December 2025 – now}}
		\textbf{Machine Learning Engineer}

		\textit{Founder Factor}
	\end{twocolentry}

	\vspace{0.10 cm}
	\begin{onecolentry}
		\textbf{Predictive Models} for Startup Success: Building machine learning models to predict Y Combinator startup success based on founder attributes and characteristics.
	\end{onecolentry}
